		...
		if(is.getPlayer().isOnline()) {
			if(is.isActive()) {
				...
				for(Location l : currentScene.keySet()) {
					...
					if(l.getBlock().getType()==Material.OAK_SIGN || l.getBlock().getType()==Material.OAK_WALL_SIGN) {
				...
				for(Location l : currentScene.keySet()) {
					...
					// Support sign data and player skulls
					if(b.getBlock().getType()==Material.OAK_SIGN || b.getBlock().getType()==Material.OAK_WALL_SIGN) {
